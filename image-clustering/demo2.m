...
rng(1)
l1 = mySpectralClustering(aff1, 2);
rng(1)
l2 = mySpectralClustering(aff1, 3);
rng(1)
l3 = mySpectralClustering(aff1, 4);

rng(1)
l4 = mySpectralClustering(aff2, 2);
rng(1)
l5 = mySpectralClustering(aff2, 3);
rng(1)
l6 = mySpectralClustering(aff2, 4);
